...
The results show that hyperparameter tuning significantly improved the performance of the Decision Tree.
...
**Application:** [MajorFit Streamlit App](https://majorfit-app.streamlit.app/)
